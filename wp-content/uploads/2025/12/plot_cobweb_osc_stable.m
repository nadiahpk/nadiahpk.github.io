...
% Parameters
slope = -0.75;           % Change this to -0.5 or -1.25
fixed_point = 5;       % Fixed point location
y0 = 2;               % Starting value
...
exportgraphics(gcf, 'cobweb_osc_stable.pdf', 'ContentType', 'vector', 'BackgroundColor', 'none')
