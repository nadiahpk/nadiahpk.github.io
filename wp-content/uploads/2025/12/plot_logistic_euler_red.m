...
h = 1;
fout_name = 'logistic_euler_stable_red.pdf';

h = 4.5;
fout_name = 'logistic_euler_unstable_red.pdf';

h = 3.5;
fout_name = 'logistic_euler_osc_stable_red.pdf';
...
% plot Euler steps
plot_properties = plot(tV, yV, 'k-', "LineWidth", 2);
hold on;
