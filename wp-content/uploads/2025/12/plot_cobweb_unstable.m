...
% Parameters
slope = -1.25;           % Change this to -0.5 or -1.25
fixed_point = 4.5;       % Fixed point location
y0 = 4;               % Starting value
n_iterations = 9;     % Number of iterations
y_max = 8;
x_max = 8;
...
exportgraphics(gcf, 'cobweb_unstable.pdf', 'ContentType', 'vector', 'BackgroundColor', 'none')
